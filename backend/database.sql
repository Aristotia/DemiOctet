...
INSERT INTO `agency` VALUES (1,'Paris','58, avenue du Général Leclerc, 92514 Boulogne Cedex','(+33) 1 41 10 01 61'),(2,'Nantes','1 Rue Haute Casserie, 44000 Nantes','(+33) 2 40 35 67 89'),(3,'Rennes','24, rue de l\'Alma, Immeuble Urban Quartz, 35000 Rennes','(+33) 2 99 67 00 22'),(4,'Aix-En-Provence','7 Route de Galice, 13100 Aix-en-Provence','(+33) 4 42 93 71 01'),(5,'Bordeaux','23 quai de Paludate - 33800 Bordeauxe','(+33) 5 57 59 02 50'),(6,'Genève','Rue du Marché 3, 1201 Genève, Suisse','(+41) 22 400 00 34'),(7,'Lyon','79 Bd Marius Vivier Merle, 69003 Lyon',' (+33) 4 37 48 31 30'),(8,'Munich','Konrad-Zuse-Platz 8, 81829 München','+49 89 20 70 42 100'),(9,'Niort','7 rue du Docteur Roux, 79000 Niort','06 35 52 79 49'),(10,'Montréal','407, rue McGill, suite 700 Montréal (QC) H2Y 2G3','+1 438 922 1299'),(11,'Brest','90 Rue Ernest Hemingway, 29200 Brest','(+33) 2 98 44 67 86'),(12,'Dijon','10 Avenue Maréchal Foch, 21000 Dijon','(+33) 7 63 62 89 35'),(13,'Lille','100 Rue Nationale, 59000 Lille','(+33) 6 40 81 20 33'),(14,'Lille','100 Rue Nationale, 59000 Lille','(+33) 3 20 79 83 30'),(15,'Clermont-Ferrand','17 rue de Sarliève, 63800 Cournon d’Auvergne','(+33) 4 73 28 57 20'),(16,'Tours','12 rue Fabienne Landy, 37700 St Pierre des Corps','(+33) 2 47 46 26 26'),(17,'Nice - Sophia Antipolis','400 avenue Roumanille, 06906 Sophia Antipolis','(+33) 4 93 00 11 05'),(18,'Strasbourg','5 allée Cérès, 67200 Strasbourg','(+33) 9 72 12 49 44'),(19,'Toulouse','21 Bd de la Marquette, 31000 Toulouse','(+33)5 61 62 02 03'),(20,'Bruxelles','Avenue des Arts, 46, 1000 Bruxelles - Belgium','(+32) 2 319 34 45'),(21,'Orléans','6 bis avenue Jean Zay, 45000 Orléans','(+33) 2 38 77 12 61'),(22,'Casablanca','203 BD ABDELMOUMEN ET BD ANOUAL, 20042 CASABLANCA','+212 5 29 05 48 67'),(23,'Le Mans','39 boulevard Demorieux R+4 sud Bat epsilon 72100 Le Mans','(+33) 2 47 46 26 26'),(24,'Aveiro','Av. Europa n.º 404, 1º Dto, 3800-230 Cacia Aveiro','(+351) 9 10 24 07 52');
...
-- Dump completed on 2022-06-29 13:42:25
...
-- Dump completed on 2022-06-29 13:10:31
...
-- Dump completed on 2022-06-29 13:10:29
...
-- Dump completed on 2022-06-29 13:10:19
...
-- Dump completed on 2022-06-29 13:42:15
...
-- Dump completed on 2022-06-29 13:10:23
...
-- Dump completed on 2022-06-29 13:10:25
...
-- Dump completed on 2022-06-29 13:10:34
...
-- Dump completed on 2022-06-29 13:10:27
